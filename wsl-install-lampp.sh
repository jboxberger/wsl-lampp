...
echo " Only needed if you want to connect via putty or WinSCP to your WSL this is not required you can always access   "
echo " the bash over bash.exe and the File System over                                                                 "
echo " %LOCALAPPDATA%\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs                   "
